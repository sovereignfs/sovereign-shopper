...
--> statement-breakpoint
CREATE UNIQUE INDEX `shopper_list_shares_list_user_idx` ON `shopper_list_shares` (`list_id`,`user_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `shopper_products_owner_normalized_idx` ON `shopper_products` (`owner_user_id`,`normalized_name`);--> statement-breakpoint
